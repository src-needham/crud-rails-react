...
class FishControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fish" do
    assert_difference('Fish.count') do
      post fish_index_url, params: { fish: { common_name: @fish.common_name, ph: @fish.ph, quantity: @fish.quantity, scientific_name: @fish.scientific_name } }
    end
  ...
  test "should update fish" do
    patch fish_url(@fish), params: { fish: { common_name: @fish.common_name, ph: @fish.ph, quantity: @fish.quantity, scientific_name: @fish.scientific_name } }
